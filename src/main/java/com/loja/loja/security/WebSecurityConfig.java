...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .antMatchers("/clientes/cadastro").permitAll()
...
/*                
                ...
                .withUser("cliente").password(new BCryptPasswordEncoder().encode("123")).roles("EDITOR")
                .and()
                .withUser("admin").password(new BCryptPasswordEncoder().encode("admin")).roles("EDITOR", "ADMIN");
*/
    }
